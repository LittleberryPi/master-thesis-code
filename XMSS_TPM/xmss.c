...
int xmss_recover_bds_data(unsigned char *sk, xmss_params *params, unsigned int *layers,
    ...
    return core_recover_bds_data(params, sk + XMSS_OID_LEN, layers, nr_of_hmaced_bds_layers);
}

int xmssmt_recover_bds_data(unsigned char *sk, xmss_params *params, unsigned int *layers,
                            unsigned int nr_of_hmaced_bds_layers) {
    uint32_t oid = 0;
    unsigned int i;
...
int xmss_sign(unsigned char *sk, xmss_params *params,
...
int xmssmt_sign(unsigned char *sk, xmss_params *params,
                unsigned char *sm, unsigned long long *smlen,
                const unsigned char *m, unsigned long long mlen)
{
    uint32_t oid = 0;
